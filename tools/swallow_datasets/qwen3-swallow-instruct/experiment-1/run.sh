...
python tools/swallow_datasets/qwen3-swallow-instruct/experiment-1/nemotron_post_training.py \
...
python tools/swallow_datasets/qwen3-swallow-instruct/experiment-1/nemotron_post_training.py \
  --input-jsonl $DATASET_DIR/Nemotron-Post-Training-Dataset-v1/code-jsonl/merge_train.jsonl \
