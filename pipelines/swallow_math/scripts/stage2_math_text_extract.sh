...
INPUT_FILE_PATH="/groups/gch51639/fujii/datasets/raw/pretrain/swallow/swallow-math-v2/stage-1/train-${INDEX}-of-00128.jsonl"
OUTPUT_DIR="/groups/gch51639/fujii/datasets/raw/pretrain/swallow/swallow-math-v2/stage-2"
mkdir -p $OUTPUT_DIR
