...
#PBS -koed
#PBS -V
#PBS -o outputs/pipeline/stage4_multiple_solution
...
OUTPUT_DIR="/groups/gch51639/fujii/datasets/raw/pretrain/swallow/swallow-math-v2/stage-4-ablations/multiple-solution/${MODEL_NAME}"
mkdir -p $OUTPUT_DIR
